  ...
  content: (
    <>
      <p>
        ...
        tentatives. Alors maintenant qu'est-ce-que sait que de se sentir
        féminine?
      </p>
      <p>
        ...
        stabilisation et de sports (heureusement!), mais j'ai aussi commencer à
      ...
      <p>
        ...
        "il était une fois". On dit que la vie ne fait pas de cadeaux mais au
        contraire, ceux qu'elle peut offrir sont très beaux. Pendant ces 13ans,
        j'ai eu pas mal d'experiences qui m'ont fait trébucher, des problèmes de
        santé, des jobs alimentaires qui ne me faisait avancer, des périodes de
        chômage pour essayer de me reconvertir... donc je ruminais. Je ne suis
        pas une princesse Disney mais vous verrez plus tard !
      </p>
      <p>
      ...
      <p>
        ...
        première experience a mis à l'épreuve l'estime de moi. C'est pourquoi à
        partir de ce moment, j'ai décidé de perdre encore plus de poids. Une
        espèce de vengeance personnelle. Je suis passé de 69 à 56 kilos en
        l'espace d'un mois et demi ! J'ai commencé à danser, à m'amuser en
        parallèle de régime. L'action qui me définit depuis tous ce temps, le
        moment où je peut enfin être, est quand je danse. Ressentir la musique,
        le tempo, laisser son corps libre de tout mouvements, ne pas voir passer
        les minutes, les heures, juste ressentir! C'est pourquoi j'allais
