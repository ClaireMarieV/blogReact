  ...
  content: (
    <>
      ...
      <p>
        ...
        pensaient que c'était un cadeau utile comme je n'en avais pas mais ça a
        aussi engendré des complexes par la suite. J'ai perdu 27kilos en 3ans
        après m'être pesée. Régimes à répétition, chacun suivi d'une période de
        stabilisation et de sports (heureusement!), mais j'ai aussi commencé à
        fumer à 19ans pour brûler des calories et perdre du poids plus vite...
        Je ne m'acceptais pas à tel point que, comme beaucoup d'autres jeunes
        femmes, je suis entrée au début dans un troubles alimentaire. Certaines
        se demanderont comment est-ce que l'on peut infliger ça à son corps dans
        le seul but de perdre du poids, prôneront le bien-être. Mais c'est vrai,
        comment? Et bien ce n'est que depuis peu que l'ont met en avant tous les
        corps. Même s'il y a eu ce phénomène marketing autour et donc
        heureusement une prise de conscience, je voyais bien le regard
        qu'avaient les hommes sur moi quand j'étais en surpoids. Aucun.
      </p>
      <p>
        Je vous dis ça parce que j'ai toujours esperé rencontrer quelqu'un comme
      ...
      <p>
        ...
        première experience a mis à l'épreuve l'estime de moi et celle que je
        pouvais avoir en les autres. C'est pourquoi à partir de ce moment, j'ai
        décidé de perdre encore plus de poids. Une espèce de vengeance
        personnelle. Je suis passé de 69 à 56 kilos en l'espace d'un mois et
        demi ! J'ai commencé à danser, à m'amuser en parallèle de régime.
        L'action qui me définit depuis tous ce temps, le moment où je peut enfin
        être, est quand je danse. Ressentir la musique, le tempo, laisser son
        ...
        des ami(e)s juste pour pouvoir me sentir libre. C'est triste à dire mais
        c'est à ce moment que le regard des hommes à changer. Comme quoi ... Et
        puis petit à petit, rencontres après rencontres, j'avais toujours ce
        système de mit en place. Cette vengeance après chaque rupture qui ne
        blessait personne, de 56 à 50 de 50 jusqu'a me stabiliser une bonne fois
        à 48. Il y a 3ans et demi à peu près, je me suis coupée de personnes qui
        étaient toxiques. Un groupe qui s'étaient trouvés parce que sans doute
        ils avaient en commun le fait de ne pas se sentir bien.
      </p>
      ...
      <p>
        ...
        temps comme une certaine élégance, une aisance dans les mouvements, une
        certaine douceur qui maintenant se dégage lorsque je laisse mon corps
        s'exprimer.
      </p>
    </>
  ),
