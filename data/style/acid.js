...
import acid from "../../public/images/style/acid.png?resize&sizes[]=250&sizes[]=300&sizes[]=450";
import roseEucalyptus from "../../public/images/style/roseEucalyptus.jpg?resize&sizes[]=250&sizes[]=300&sizes[]=450";
    ...
    <>
      ...
      <Framer>
        <p>
          ...
          femme peut mettre en avant. Il y a oui, le maquillage, mais il y a
          aussi toutes ces petites choses comme retrousser son pantalon pour
          mettre en avant ses chevilles, ou bien enlacer une de ses chevilles
          d'une chaîne. Parer sa nuque de colliers, la rehausser d'un tatouage.
          Mettre en valeur ou plutôt se mettre en valeur avec de petites choses
          qui donneront confiance.
        </p>
      </Framer>
    </>
  ),
